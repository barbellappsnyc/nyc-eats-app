class CuisineConstants {
  ...
  // Tibetan
  static const List<String> _bo = [
    'མཉེས་པོ་ཞིག',
    'ཞིམ་པོ་འདུག',
    'བཀྲ་ཤིས་བདེ་ལེགས',
  ];
  // Burmese
  static const List<String> _my = [
    'စားကောင်းပါစေ',
    'အရမ်းစားကောင်းတယ်',
    'အောင်မြင်ပါစေ',
  ];
  // Khmer/Cambodian
  static const List<String> _km = [
    'សូមទទួលទានឲ្យបានឆ្ងាញ់',
    'ឆ្ងាញ់ណាស់',
    'ជល់មួយ',
  ];
  // Sinhala (Sri Lankan)
  ...
  // Nepali
  static const List<String> _ne = [
    'खानाको आनन्द लिनुहोस्',
    'धेरै मीठो छ',
    'जय होस',
  ];
  // Patois / Creole (Caribbean)
  static const List<String> _jm = [
    'Nyam it up',
    'Lick yuh lips',
    'Jah bless',
    'Bon apeti',
  ...
  static const List<String> _usAirports = [
    'JFK',
    'LGA',
    'EWR',
    'LAX',
  ...
  static const List<String> _auAirports = [
    'SYD',
    'MEL',
    'BNE',
    'PER',
  ...
  static const List<String> _brAirports = [
    'GRU',
    'GIG',
    'BSB',
    'CNF',
  ...
  static const List<String> _cnAirports = [
    'PEK',
    'PVG',
    'CAN',
    'CTU',
  ...
  static const List<String> _frAirports = [
    'CDG',
    'ORY',
    'NCE',
    'LYS',
  ...
  static const List<String> _grAirports = [
    'ATH',
    'SKG',
    'HER',
    'RHO',
  ...
  static const List<String> _inAirports = [
    'DEL',
    'BOM',
    'BLR',
    'HYD',
  ...
  static const List<String> _itAirports = [
    'FCO',
    'MXP',
    'VCE',
    'NAP',
  ...
  static const List<String> _jpAirports = [
    'NRT',
    'HND',
    'KIX',
    'ITM',
  ...
  static const List<String> _mxAirports = [
    'MEX',
    'CUN',
    'GDL',
    'MTY',
  ...
  static const List<String> _esAirports = [
    'MAD',
    'BCN',
    'PMI',
    'AGP',
  ...
  static const List<String> _thAirports = [
    'BKK',
    'DMK',
    'HKT',
    'CNX',
  ...
  static const List<String> _vnAirports = [
    'SGN',
    'HAN',
    'DAD',
    'CXR',
  ...
  static const List<String> _africanAirports = [
    'JNB',
    'CPT',
    'NBO',
    'ADD',
  ...
  static const List<String> _arabAirports = [
    'DXB',
    'AUH',
    'DOH',
    'RUH',
  ...
  static const List<String> _asianAirports = [
    'SIN',
    'BKK',
    'NRT',
    'ICN',
  ...
  static const List<String> _caribbeanAirports = [
    'NAS',
    'SJU',
    'BGI',
    'POS',
  ...
  static const List<String> _latamAirports = [
    'PTY',
    'LIM',
    'SCL',
    'EZE',
  ...
  static const List<String> _medAirports = [
    'MLA',
    'LCA',
    'PFO',
    'PMO',
  ...
  static const List<String> _meAirports = [
    'DOH',
    'DXB',
    'AMM',
    'BEY',
  ...
  static const List<String> _nordicAirports = [
    'CPH',
    'OSL',
    'ARN',
    'HEL',
  ...
  static const List<String> _westAfricanAirports = [
    'LOS',
    'ACC',
    'DKR',
    'ABJ',
  ...
  static const List<String> _cantoneseAirports = [
    'CAN',
    'SZX',
    'MFM',
    'HKG',
  ...
  static const List<String> _hawaiianAirports = [
    'HNL',
    'OGG',
    'KOA',
    'LIH',
  ...
  static const List<String> _himalayanAirports = [
    'KTM',
    'PBH',
    'LXA',
    'IXB',
  ...
  static const List<String> _southernAirports = [
    'ATL',
    'MSY',
    'BNA',
    'CHS',
  ...
  static const List<String> _defaultAirports = [
    'JFK',
    'LGA',
    'EWR',
    'LHR',
  ...
  static const Map<String, String> airportCityNames = {
    ...
    'VLC': 'Valencia',
    'LHR': 'London',
    'DUB': 'Baile Átha Cliath / Dublin',
    'ORK': 'Corcaigh / Cork',
    'SNN': 'Sionna / Shannon',
    'NOC': 'Cnoc Mhuire / Knock',
    'ATH': 'Αθήνα / Athens',
    'SKG': 'Θεσσαλονίκη / Thessaloniki',
    'HER': 'Ηράκλειο / Heraklion',
    'RHO': 'Ρόδος / Rhodes',
    'CFU': 'Κέρκυρα / Corfu',
    'JMK': 'Μύκονος / Mykonos',
    'JTR': 'Σαντορίνη / Santorini',
    'LIS': 'Lisboa / Lisbon',
    'OPO': 'Porto',
    'FAO': 'Faro',
    'FNC': 'Funchal',
    ...
    'DMK': 'กรุงเทพมหานคร / Bangkok',
    'HKT': 'ภูเก็ต / Phuket',
    'CNX': 'เชียงใหม่ / Chiang Mai',
    'USM': 'เกาะสมุย / Koh Samui',
    'KBV': 'กระบี่ / Krabi',
    'SGN': 'Hồ Chí Minh / Ho Chi Minh City',
    'HAN': 'Hà Nội / Hanoi',
    'DAD': 'Đà Nẵng / Da Nang',
    'CXR': 'Nha Trang',
    'PQC': 'Phú Quốc',
    'HPH': 'Hải Phòng / Hai Phong',
    'MNL': 'Maynila / Manila',
    'CEB': 'Cebu',
    'DVO': 'Davao',
    'CRK': 'Angeles / Clark',
    'ILO': 'Iloilo',
    'KUL': 'Kuala Lumpur',
    'PEN': 'Pulau Pinang / Penang',
    'BKI': 'Kota Kinabalu',
    'KCH': 'Kuching',
    'JHB': 'Johor Bahru',
    'SIN': 'Singapore',
    'PNH': 'ភ្នំពេញ / Phnom Penh',
    'REP': 'ក្រុងសៀមរាប / Siem Reap',
    'KOS': 'ក្រុងព្រះសីហនុ / Sihanoukville',
    'DEL': 'नई दिल्ली / New Delhi',
    'BOM': 'मुंबई / Mumbai',
    'BLR': 'ಬೆಂಗಳೂರು / Bangalore',
    'HYD': 'హైదరాబాద్ / Hyderabad',
    'MAA': 'சென்னை / Chennai',
    'CCU': 'কলকাতা / Kolkata',
    'COK': 'കൊച്ചി / Kochi',
    'AMD': 'અમદાવાદ / Ahmedabad',
    'KTM': 'काठमाडौं / Kathmandu',
    'PBH': 'སྤ་རོ་ / Paro',
    'LXA': 'ལྷ་ས་ / Lhasa',
    'IXB': 'Siliguri / Bagdogra',
    'SXR': 'سِری نَگَر / Srinagar',
    'ALA': 'Алматы / Almaty',
    'NQZ': 'Астана / Astana',
    'CIT': 'Шымкент / Shymkent',
    'KGF': 'Қарағанды / Karaganda',
    'GUW': 'Атырау / Atyrau',
    'TAS': 'Toshkent / Tashkent',
    'SKD': 'Samarqand / Samarkand',
    'NMA': 'Namangan',
    'BHK': 'Buxoro / Bukhara',
    'FEG': 'Fargʻona / Fergana',
    'URC': 'ئۈرۈمچى / Ürümqi',
    'KHG': 'قەشقەر / Kashgar',
    'KCA': 'كۇچار / Kuqa',
    'HTN': 'خوتەن / Hotan',
