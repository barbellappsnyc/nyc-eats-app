...
class _PassportDetailScreenState extends State<PassportDetailScreen>
  ...
  bool _showMiniGallery =
      false; // 🌟 NEW: Tracks if the mini-gallery overlay is open
  ...
  Future<void> _loadPhotoboothMemories() async {
    ...
    setState(() {
      ...
      _savedDateText =
          prefs.getString('${memoryKey}_date') ??
    ...
    final List<String> cachedStampNames =
        prefs.getStringList(stampMemoryKey) ?? [];
  ...
  Future<void> _pickStampPhotos() async {
    try {
      ...
      for (int i = 0; i < validImages.length; i++) {
        ...
        final String fileName =
            '${widget.heroTag}_stamp_${DateTime.now().millisecondsSinceEpoch}_$i.png';
        final String permanentPath = '${directory.path}/$fileName';
      ...
      List<String> updatedFileNames = _stampPhotoPaths
    ...
    setState(() {
      ...
      if (_stampPhotoPaths.length < 3 && _isShowingPhotoStamps) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              "Not enough photos! Switched back to standard stamps. 📮",
            ),
            backgroundColor: Color(0xFFD32F2F),
            behavior: SnackBarBehavior.floating,
            duration: Duration(seconds: 3),
  ...
  Future<void> _pickDate() async {
    ...
    if (picked != null) {
      final formattedDate =
          "${_getShortMonth(picked.month)} ${picked.day}, ${picked.year}";
              ...
              builder: (context, controller) => Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      "Tap the background to change the artwork. Pinch and twist the passport to adjust its placement.",
                      style: TextStyle(
            ...
            TargetContent(
              ...
              builder: (context, controller) => Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  const Text(
                    "Save it to your camera roll or share it to your story.\n\nNow, let's visit the Shop.",
  ...
  void _updateDefaultCardPosition(int previousIndex) {
    ...
    setState(() {
      ...
      if (_currentBgIndex == 5) {
        bool hasBottomBlobs =
            _mtaStations.length == 2 || _mtaStations.length >= 4;
      ...
      // 2. ENTERING PHOTOBOOTH TABLETHROW (Index 8)
        ...
        if (_isPassportInTopSlot) {
          ...
          _stripPosition = Offset(
            centerX,
            topPadding + visualCardH + gap + (visualStripH / 2),
          );
        } else {
          ...
          _cardPosition = Offset(
            centerX,
            topPadding + visualStripH + gap + (visualCardH / 2),
          );
        }
      }
  ...
  Future<void> _saveToCameraRoll() async {
    ...
    try {
      ...
      final imagePath =
          '${directory.path}/nyceats_passport_${DateTime.now().millisecondsSinceEpoch}.png';
  ...
  Future<void> _shareToStory() async {
    try {
      final Uint8List? imageBytes = await _fullScreenController.capture(
        pixelRatio: 3.0,
      );
      if (imageBytes == null) return;
      ...
      final directory = await getTemporaryDirectory();
      final imagePath =
          '${directory.path}/nyceats_story_${DateTime.now().millisecondsSinceEpoch}.png';
      final imageFile = File(imagePath);
      await imageFile.writeAsBytes(imageBytes);
          ...
          SnackBar(
            content: Row(
              children: const [
                ...
                Expanded(
                  child: Text(
                    "Offline. Displaying fallback transit data.",
                    style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontFamily: 'SFPro',
                    ),
  ...
  Widget build(BuildContext context) {
    ...
    double derivedVisualCardH =
        cardWidth * ((MediaQuery.of(context).size.width * 0.88) / cardHeight);

    double safeTopY = clampTopPadding;
    double safeBottomY =
        MediaQuery.of(context).size.height - clampBottomPadding;
    ...
    double bottomClampBuffer =
        stripWidth / 2; // (Since strip is rotated, stripWidth is visual height)
        ...
        child: IgnorePointer(
          ...
          child: AnimatedContainer(
            ...
            child: GestureDetector(
              behavior:
                  HitTestBehavior.opaque, // 🛡️ FORCES the layer to be "solid"
              onTap:
                  () {}, // 🛑 CONSUMES the tap so it doesn't hit the background
              ...
              child: PhotoStripCard(
                borough: "MANHATTAN",
                dateText: _savedDateText.isEmpty
                    ? "SELECT DATE"
                    : _savedDateText,
                ...
                loadingSlotIndex:
                    _loadingSlotIndex, // 👈 4. PASS THE STATE VARIABLE HERE
              ),
            ),
          ),
        ),
                  ...
                  Positioned(
                    ...
                    child: GestureDetector(
                      ...
                      onTapUp: (_) {
                        ...
                        setState(() {
                          _currentBgIndex =
                              (_currentBgIndex + 1) % bgDesigns.length;
                        });
                          ...
                          child: Row(
                            ...
                            children: [
                              _buildGroovedButton(
                                ...
                                isLoading:
                                    _isSavingToCameraRoll, // 👈 PASS THE STATE HERE
                              ...
                              if (_currentBgIndex == 4)
                                _buildGroovedButton(
                                  ...
                                  icon: _isShowingPhotoStamps
                                      ? CupertinoIcons.ticket_fill
                                      : CupertinoIcons.camera_fill,
                                  color: _isShowingPhotoStamps
                                      ? Colors.amber
                                      : Colors.white,
                                  onTap: () {
                              ...
                              if (_currentBgIndex == 4 &&
                                ...
                                _buildGroovedButton(
                                  ...
                                  onTap: () {
                                    ...
                                    setState(
                                      () =>
                                          _showMiniGallery = !_showMiniGallery,
                                    );
                                  },
                                ),
                              ...
                              if (_currentBgIndex == 5)
                                ...
                                _buildGroovedButton(
                                  icon: _isMtaNightMode
                                      ? CupertinoIcons.moon_stars_fill
                                      : CupertinoIcons.sun_max_fill,
                                  color: _isMtaNightMode
                                      ? Colors.indigo[300]!
                                      : Colors.amber,
                                  onTap: () {
                                    setState(() {
    ...
    switch (index) {
      case 0:
        return {
          "title": "The Monolith",
          "desc":
              "A clean slate perfectly matched to your passport's primary color code.",
      ...
      case 1:
        return {
          "title": "Baggage Claim",
          "desc":
              "Global airport baggage tags routing you directly from JFK to the world.",
      ...
      case 2:
        return {
          "title": "The Pizzeria",
          "desc":
              "The classic red-and-white gingham tablecloth. Perfect for a slice.",
      ...
      case 3:
        return {
          ...
          "desc":
              "A pastel collage of the exact GPS locations from your culinary journey.",
      ...
      case 4:
        return {
          ...
          "desc":
              "Custom stamps featuring native emojis.\n\nTap the camera icon to load your own memories.",
      ...
      case 5:
        return {
          "title": "The Commuter",
          "desc":
              "Live subway routings.\n\nTap the sun/moon icon to switch between day and night mode.",
      ...
      case 6:
        return {
          "title": "Transparent",
          "desc":
              "A completely clear background. Perfect for downloading your passport card exactly as it is.",
          "icon": Icons.grid_4x4,
        };
      case 7:
        return {
          "title": "Pop Art",
          "desc":
              "A tribute to the legendary New York artist Andy Warhol. A six-panel Marilyn Diptych style print featuring your cuisine's native emoji.",
      ...
      case 8:
        return {
          ...
          "desc":
              "A late-night photobooth strip.\n\nDrag to tear it off, and tap the squares to load 4 of your favorite snaps.",
          "icon": CupertinoIcons.camera_fill,
        };
      default:
        return {
          "title": "Artwork",
          "desc": "A unique visual memory of your travels.",
...
class _JigglingThumbnailState extends State<JigglingThumbnail>
    with SingleTickerProviderStateMixin {
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.black.withOpacity(
                    0.5,
                  ), // 🌟 THE FIX: Sleek translucent grey
                  shape: BoxShape.circle,
                  border: Border.all(
