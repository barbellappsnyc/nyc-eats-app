...
class _MapScreenState extends State<MapScreen>
  ...
  Future<void> _handlePassportTap() async {
    ...
    // 🛑 If they are mid-tutorial, teleport them directly without showing the note
    if (tutorialStage == 'collection_screen') {
      _navigateToPassport();
      return;
    }
    ...
    // 🚪 Show the note if needed, and navigate to the passport when it closes
    await TravelerNoteDialog.showIfNeeded(
      context,
      onDismiss: () => _navigateToPassport(),
    );
  }
